...
# We can use the mvrnorm() function to simulate 20700 data points.
...
# the function in detail. The same thing can be achieved using
# the kd() function under semTools, rather than nvnorm()
